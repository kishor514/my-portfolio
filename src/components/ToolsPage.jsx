...
export default function ToolsPage({ onBack, onNavigate }) {
  return (
    <motion.div 
      ...
      <div className="mx-auto w-full max-w-[650px] px-4">
        ...
        >
          <motion.div variants={fadeInUp} className="flex h-24 w-24 items-center justify-center rounded-full bg-[#161616] mb-10 shadow-inner overflow-hidden">
            <Wrench size={40} className="text-yellow-400" strokeWidth={1.5} />
          </motion.div>
          ...
          <motion.p variants={fadeInUp} className="text-[#a0a0a0] text-[1.05rem] leading-[1.7] max-w-[500px] mb-14">
            Using modern development and collaboration tools for coding, API testing, database management, and version control.
          </motion.p>

          <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-4">
            {['VS Code', 'Git', 'GitHub', 'XAMPP'].map((tech) => (
              <motion.div 
