...
export default function FrontendPage({ onBack, onNavigate }) {
  return (
    <motion.div 
      ...
      <div className="mx-auto w-full max-w-[650px] px-4">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-[#a0a0a0] text-[1.05rem] leading-[1.7] max-w-[500px] mb-14">
            Building responsive and interactive web interfaces with modern frontend technologies, focused on clean layouts and practical user experiences.
          </motion.p>

          <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-4">
            {['HTML', 'CSS', 'JavaScript', 'TypeScript', 'React.js'].map((tech) => (
              <motion.div 
